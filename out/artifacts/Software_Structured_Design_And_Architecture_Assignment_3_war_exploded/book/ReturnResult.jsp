...
<body>
<jsp:useBean id="returnedRecord" type="model.BorrowrecordEntity" scope="session"/>
<jsp:useBean id="resultMessage" type="java.lang.String" scope="session"/>
...
<div class="jumbotron jumbotron-fluid">
    <div class="container">
        <h1 class="display-4">You are returning, record id
            <jsp:getProperty name="returnedRecord" property="rid"/>
        </h1>
        <p class="lead">
