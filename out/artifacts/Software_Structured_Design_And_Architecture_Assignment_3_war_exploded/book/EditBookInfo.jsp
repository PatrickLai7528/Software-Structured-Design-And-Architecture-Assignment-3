...
<body>
<jsp:useBean id="selectedBook" type="model.BookEntity" scope="session"/>
...
<nav class="navbar navbar-light bg-light">
    <a class="navbar-brand" href="<%out.println(request.getContextPath() + "/index");%>">
        ...
        You are editing book info
    </a>
</nav>
<form style="margin: 12px;" action="${pageContext.request.contextPath}/EditBookInfo" method="post">
    <div class="form-group">
        <label for="name">Name</label>
        <input type="text" class="form-control" id="name" name="name"
               placeholder="<%out.println(selectedBook.getBname());%>">
    </div>
    <div class="form-group">
        <label for="description">Description</label>
        <input type="text" class="form-control" id="description" name="description"
               placeholder="<%out.println(selectedBook.getDescription());%>">
    </div>
    <div class="form-group">
        <label for="quantity">Quantity</label>
        <input type="text" class="form-control" id="quantity" name="quantity"
               placeholder="<%out.println(selectedBook.getQuantity());%>">
    </div>
    <div class="form-group">
        <label for="type">Type</label>
        <input type="text" class="form-control" id="type" name="type"
               placeholder="<%out.println(selectedBook.getType());%>">
    </div>
    <div class="form-group">
        <label for="fineRate">Fine Rate</label>
        <input type="text" class="form-control" id="fineRate" name="fineRate"
               placeholder="<%out.println(selectedBook.getFinerate());%>">
    </div>
