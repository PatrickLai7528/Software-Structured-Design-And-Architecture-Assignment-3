<%@ page import="model.FinerecordEntity" %><%--
...
<body>
<jsp:useBean id="fineRecordList" type="java.util.ArrayList<model.FinerecordEntity>" scope="session"/>
...
<ul class="nav border nav-pills">
    <li class="nav-item" style="margin: 8px">
        <a class="nav-link <%%>" href="<%out.println(request.getContextPath()+"/FineRecord?userId=1");%>">Check
            undergraduate</a>
    </li>
    <li class="nav-item" style="margin: 8px">
        <a class="nav-link" href="<%out.println(request.getContextPath()+"/FineRecord?userId=2");%>">Check graduate</a>
    </li>
    <li class="nav-item" style="margin: 8px">
        <a class="nav-link" href="<%out.println(request.getContextPath()+"/FineRecord?userId=3");%>">Check teacher</a>
    </li>
</ul>
<table class="table table-striped">
    ...
    <tbody>
    <%for (FinerecordEntity finerecordEntity : fineRecordList) { %>
    <tr>
        <th scope="row" class="align-middle">
            <%out.println(finerecordEntity.getFid());%>
        </th>
        <td class="align-middle">
            <%out.println(finerecordEntity.getBid());%>
        </td>
        <td class="align-middle">
            <%out.println(finerecordEntity.getUid());%>
        </td>
        <td class="align-middle">
            <%out.println(finerecordEntity.getLatedate());%>
        </td>
        <td class="align-middle">
            <%out.println(finerecordEntity.getFinetotal());%>
        </td>
    </tr>
    <%}%>
    </tbody>
