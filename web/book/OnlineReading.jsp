...
<jsp:useBean id="readingContent" type="java.lang.String" scope="session"/>
...
<ul class="nav border nav-pills">
    <li class="nav-item" style="margin: 8px">
        <a
                class="nav-link"
                href="<%out.println(request.getContextPath()+"/OnlineReadBook?bookId="+selectedBook.getBid()+"&format=Word");%>">
            Read As Word
        </a>
    </li>
    <li class="nav-item" style="margin: 8px">
        <a
                class="nav-link"
                href="<%out.println(request.getContextPath()+"/OnlineReadBook?bookId="+selectedBook.getBid()+"&format=PDF");%>">
            Read As PDF
        </a>
    </li>
    <li class="nav-item" style="margin: 8px">
        <a
                class="nav-link"
                href="<%out.println(request.getContextPath()+"/OnlineReadBook?bookId="+selectedBook.getBid()+"&format=EPUB");%>">Read
            As
            EPUB</a>
    </li>
</ul>
<div class="jumbotron">
    <h1 class="display-4">
        <p><% out.println(readingContent);%></p>
    </h1>
</div>
</body>
</html>
